...
export default function ApiKeySetup({ onComplete, lang = "en" }: ApiKeySetupProps) {
  ...
  const text = {
    en: {
      ...
      step2Desc: "Open your browser's developer console (F12 or Cmd+Option+J) and paste this command:",
    ...
    es: {
      ...
      step2Desc: "Abre la consola de desarrollador (F12 o Cmd+Option+J) y pega este comando:",
    ...
    pt: {
      ...
      step2Desc: "Abra o console do desenvolvedor (F12 ou Cmd+Option+J) e cole este comando:",
      copyCommand: "Copiar Comando",
      copiedCommand: "Copiado!",
