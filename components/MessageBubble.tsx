...
function renderCorrectionText(text: string): React.ReactNode[] {
...
export default function MessageBubble({
  ...
  return (
    <div className={`flex flex-col ${isUser ? "items-end" : "items-start"} mb-3`}>
      ...
      {/* Grammar correction box - below user messages */}
      {isUser && correction && (
        <div className="mt-1 max-w-[85%] sm:max-w-[75%] px-3 py-1.5 bg-amber-50 border border-amber-200 rounded-lg">
          <p className="text-xs text-amber-900 leading-relaxed">
            {renderCorrectionText(correction)}
          </p>
        </div>
      )}
    </div>
